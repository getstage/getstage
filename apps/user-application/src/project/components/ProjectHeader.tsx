...
export function ProjectHeader({
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <div className="grid gap-[10px] xl:grid-cols-[minmax(0,1fr)_auto] xl:items-start">
        <div className="flex min-w-0 max-w-full items-center gap-2 overflow-x-auto rounded-[8px] bg-[#F5F5F5] p-[2px]">
          {PAGE_TABS.map((tab) => {
