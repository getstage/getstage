...
function PreviewTaskCard({
  ...
  if (isRevision) {
    return (
      <div
        ...
        className={`select-none rounded-[8px] bg-gradient-to-b from-white to-[#fafafa] p-[16px] transition-[transform,box-shadow] shadow-[0_0.45px_0.5px_rgba(10,10,10,0.25)] ${dragging ? "rotate-[-2deg] cursor-grabbing shadow-[0_8px_22px_rgba(10,10,10,0.14)]" : "cursor-grab active:cursor-grabbing"}`}
      >
  ...
  return (
    <div
      onPointerDown={onPointerDown}
      className={`select-none rounded-[8px] bg-gradient-to-b from-white to-[#fafafa] p-[clamp(12px,2vw,16px)] transition-[transform,box-shadow] shadow-[0_0.45px_0.5px_rgba(10,10,10,0.25)] ${dragging ? "rotate-[-2deg] cursor-grabbing shadow-[0_8px_22px_rgba(10,10,10,0.14)]" : "cursor-grab active:cursor-grabbing"}`}
    >
      <div className="flex flex-col gap-[12px]">
