export function PlusIcon({ className = "h-[15px] w-[15px] shrink-0 text-[#737373]" }: { className?: string }) {
  return (
...
export function ScreenIcon({ size = 15 }: { size?: number }) {
  return (
    <svg
      viewBox="0 0 16 16"
      fill="none"
...
export function SaveIcon({ className = "h-[14px] w-[14px] shrink-0" }: { className?: string }) {
  return (
...
export function ChevronDownIcon({ expanded = false }: { expanded?: boolean }) {
  return (
