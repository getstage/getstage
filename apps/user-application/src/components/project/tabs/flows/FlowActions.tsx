  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="inline-flex h-[32px] items-center gap-2 rounded-[6px] border border-[rgba(158,153,248,0.45)] bg-[#FAFAFA] px-3 text-[13px] font-medium leading-[1.25] text-[#463FBA] shadow-[0_0.45px_0.5px_rgba(10,10,10,0.15)] transition-colors hover:bg-white disabled:cursor-not-allowed disabled:opacity-60"
      >
