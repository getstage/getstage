      ...
      {isEditing ? (
        <div className="rounded-[8px] border border-[#E5E5E5] bg-[#FAFAFA] p-3 shadow-[0_0.45px_0.5px_rgba(10,10,10,0.15)]">
          ...
          <button
            ...
            className="mt-4 inline-flex h-[27px] cursor-pointer items-center gap-2 rounded-[4px] bg-white px-3 py-[6px] text-[12px] font-medium leading-[1.25] text-[#7C3AED] shadow-[0_0.45px_0.5px_rgba(10,10,10,0.25)] transition-colors hover:bg-[#F5F3FF]"
          >
            <RegenerateIcon />
            Regenerate with AI
          </button>
