...
getstarted=f'''<body class="download-page"><div id="top"></div><header class="download-navigation"><a class="download-brand" href="/">{icon('stage-symbol','brand-symbol')}<span>Stage</span></a><nav aria-label="Download page navigation"><a href="/#shift">About</a><a href="/#faq">FAQ</a></nav></header><main class="download-main"><div class="download-status" id="download-status" role="status">The Stage installer is not available in this preview yet.</div><h1>Get started<br>with Stage.</h1><div class="onboarding-grid"><article class="onboarding-step"><div class="onboarding-art install-art"><div class="installer-window"><span class="installer-window-label">Stage for macOS</span><img src="/assets/stage-logo.png" width="100" height="100" alt="Stage app icon"><span>Stage</span></div></div><h2>1. Open Stage on your Mac.</h2><p>Install Stage, then launch the app to begin.</p></article><article class="onboarding-step category-step"><div class="onboarding-art category-art"><div class="category-window"><div>{icon('stage-symbol','brand-symbol')}<span>Stage</span></div><h3>What are you building?</h3><div class="category-options"><span>Websites</span><span class="selected">Web apps {icon('tick')}</span><span>iOS apps</span></div></div></div><h2>2. Choose what you are building.</h2><p>Choose Websites, Web apps or iOS apps so Stage can find the right kind of references.</p></article><article class="onboarding-step"><div class="onboarding-art research-onboarding"><div class="onboarding-reference"><span>{icon('search')} Research</span><img src="/assets/research-reference.png" width="2732" height="1928" alt="A product reference from the supplied Stage design"></div></div><h2>3. Start with the research.</h2><p>Work through the references, then carry your decisions through to the export.</p></article></div></main>{footer()}{dialog()}<script src="/config.js"></script><script src="/site.js" defer></script></body></html>'''
