...
- **Desktop routing conventions:** `apps/user-application/docs/05-11/05-11-tanstack-router-auth-en-data.md`

Convex owns **authorization in queries/mutations**; TanStack Query owns **client cache, keys, and mutations UX**. Do not replace Convex auth checks with “trust the client” patterns.
