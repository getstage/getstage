...
- **Desktop: guards vs mutations:** `apps/user-application/docs/05-11/05-11-tanstack-router-auth-en-data.md`

Use **`beforeLoad` / `redirect`** for navigation gates. Keep **Convex identity checks** in Convex — the router only decides whether to send the user to login or an upgrade route.
