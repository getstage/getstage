...
**Current desktop version (release branch):** `0.2.46` (production tag `prod-v0.2.46`; production Convex deployed from the matching `work` merge). Testing feed also published `v0.2.46`. Draft PR #81 for the Solo Invite Member upgrade entry is not merged or deployed; Stripe portal plan switching and downgrade/seat enforcement remain blocked.
