...
- Full history: `apps/user-application/docs/05-05-stage-monorepo-architecture.md`
- Clean ownership: `apps/user-application/docs/05-28/05-28-clean-monorepo-architecture-plan.md`
