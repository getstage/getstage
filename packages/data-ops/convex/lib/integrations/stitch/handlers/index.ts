...
import { buildGeneratedDesignKey } from "../../../../helpers/integrations/stitch/assets";
import { buildStitchProjectUrl, extractStitchProjectIdFromUrl } from "../../../../helpers/integrations/stitch/url";
import {
  stitchDeviceTypeValidator,
  stitchModelIdValidator,
  syncProjectDesignScreenValidator,
  type DesignConnectionStatus,
  type GeneratedDesignSource,
  type GeneratedDesignStatus,
