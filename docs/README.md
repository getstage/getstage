...
| [`STA-33_RESEARCH_CATEGORY_BREAKAGE.md`](./STA-33_RESEARCH_CATEGORY_BREAKAGE.md) | Websites click vs Refero run — missing `projectCategory` on live Convex, silent Web apps fallback |
