...
export const heroImg: React.CSSProperties = {
  display: "block",
  width: "100%",
  maxWidth: "560px",
  height: "auto",
...
export const logoSectionNoHero: React.CSSProperties = {
  margin: "48px 40px 32px",
};

export const sectionImageWrap: React.CSSProperties = {
  margin: "8px 0 24px",
  padding: gutter,
  lineHeight: 0,
};

export const sectionImage: React.CSSProperties = {
  display: "block",
  width: "100%",
  height: "auto",
...
export const wordmarkText: React.CSSProperties = {
  fontFamily: fontStack,
  fontSize: "20px",
  fontWeight: 700,
...
export const ctaCell: React.CSSProperties = {
...
export const secondaryLinkRow: React.CSSProperties = {
  fontFamily: fontStack,
  fontSize: "14px",
  fontWeight: 500,
  lineHeight: "22px",
...
export const postscript: React.CSSProperties = {
  fontFamily: fontStack,
  fontSize: "14px",
  fontWeight: 400,
  lineHeight: "22px",
...
export const stepIconCell: React.CSSProperties = {
  width: "36px",
  paddingRight: "14px",
  paddingTop: "0px",
  verticalAlign: "top",
...
export const stepIconChip: React.CSSProperties = {
  width: "36px",
  height: "36px",
  backgroundColor: BRAND,
  borderRadius: "8px",
...
export const stepIcon: React.CSSProperties = {
  display: "inline-block",
  width: "20px",
  height: "20px",
  border: 0,
